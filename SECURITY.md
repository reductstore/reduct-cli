...
Security updates are provided for the latest stable release of `reductstore/reduct-cli` unless stated otherwise in
...
- Use GitHub Security Advisories for this repository:
  https://github.com/reductstore/reduct-cli/security/advisories/new
