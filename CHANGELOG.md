...
- Add destination prefixes to replica create, update, and show commands.
...
- Add lifecycle policy API support, [PR-221](https://github.com/reductstore/reduct-cli/pull/221)
